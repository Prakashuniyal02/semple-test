...
export const metadata = { title: 'Programs & Courses | University of Allahabad' };
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 flex flex-col pt-0 lg:pt-[120px]">
      <section className="relative w-full h-[250px] md:h-[350px] bg-[#111] overflow-hidden flex items-center justify-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white z-10 drop-shadow-md tracking-tight uppercase">Programs & Courses</h1>
      ...
      <section className="w-full max-w-[1200px] mx-auto px-6 py-16">
        <div className="bg-white p-8 md:p-12 rounded-xl shadow-md border border-gray-100 min-h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Programs & Courses Section Upcoming</h2>
          <p className="text-gray-500 max-w-lg text-lg leading-relaxed">
            This is a placeholder page for the Programs & Courses section. The content and features for this page are currently under development and will be available soon.
          </p>
        </div>
      </section>
    </div>
